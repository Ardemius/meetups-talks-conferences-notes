...
The workshop will be done on *GKE* (*Google Kubernetes Engine*)

*registering for the Sfeir demos*: https://goo.gl/forms/cY9HxHvsjLouF9LG3

The GitHub repo of the demos is: https://github.com/Sfeir/kubernetes-istio-workshop +
And for the explanations, check here: https://sfeir.github.io/kubernetes-istio-workshop/kubernetes-istio-workshop/1.0.0/index.html
...
I do also add my favorite `git log` aliases, and apparently I finished to setup my GCP et Cloud Shell, and I'm ready to start "Part1: Kubernetes"
