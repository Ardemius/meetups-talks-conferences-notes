...
* De l'*IA*, surtout de l'*IA générative*, presque *partout* et d'ici peu, des *assistants PERSONNALISES* (c'est vraiment le concept clé) dans toutes les poches (via nos smartphones)
    ** On assiste vraiment à la diffusion de l'IA générative chez chacun et chacun via ces assistants personnalisés qui vous comprennent, là où auparavant c'était à nous de nous "adapter à eux / à la technologie"
