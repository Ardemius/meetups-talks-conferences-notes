...
* *Volocity* le prochain taxi volant
...
* *La Poste* et son fantastique Lego motorisé de 103 000 pièces et 8 mois de travail +
image:20240523_Viva-Tech_La-Poste_01.jpg[width=800]
+
video::20240523_Viva-Tech_La-Poste_02.mp4[width=800]

* *Renault* et sa future gamme utilitaire FlexEVan, ici déclinée en une salle de consultation médicale mobile : le U1st Vision +
image:20240524_Viva-Tech_Renault_02.jpg[width=800]
image:20240524_Viva-Tech_Renault_03.jpg[width=800]
    ** La société derrière ce concept récupère des données de santé OpenData ET de la société "Kanopy" (à vérifier) pour déployer ce van dans les lieux où les médecins manquent le plus (déserts médicaux)
