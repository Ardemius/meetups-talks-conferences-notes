...
=== 12:35 -> 12:50 - quickie - Paris 143 : Maîtriser les Tests de Code Asynchrone

.Yifang dong - Murex
====
Software engineer enjoys reading and writing code, solving problems with constraints and trade-offs. I believe that software craftsmanship can make me a better developer.
====

.abstract
====
Nous savons tous que les tests sont essentiels pour la qualité du code. Mais lorsqu'il s'agit de code asynchrone, les choses se compliquent

Venez et apprenez des astuces afin d'éviter les maux de tête liés aux tests instables et améliorer la couverture de test de votre système.

Au cours de cette présentation, vous découvrirez comment CountDownLatch et CompletableFuture peuvent vous aider à tester des opérations asynchrones. Acquérez une meilleure compréhension de l'écriture de tests d'intégration solides. De plus, explorez l'art du refactoring pour simplifier les tests en séparant la logique métier des requêtes asynchrones.

Ne manquez pas cette opportunité de perfectionner vos compétences en matière de tests et de vous assurer que vos tests restent fiables.
====
