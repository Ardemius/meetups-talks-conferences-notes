...
* *Agentic RAG* : 
    ...
    ** Et pour répondre à ce type de questions, on va pouvoir passer à un workflow plus complexe, nos *Agentic RAG* : +
...
image:202506_AI-Agents-guillaume-laforge_12.jpg[width=400] image:202506_AI-Agents-guillaume-laforge_13.jpg[width=400] 
    ...
    ** STDIO ou HTTP SSE : +
    image:202506_AI-Agents-guillaume-laforge_14.jpg[] 
        *** Protocole plutôt stateful

    ** Tools, ressources, prompts : +
    ...
    ** Mais actuellement, encore des trous dans la raquette en matière de *sécurité* et d'*observabilité* : 
